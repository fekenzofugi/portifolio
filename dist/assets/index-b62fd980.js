...
`,M1=[{name:"4any1 Assessoria de Corrida",description:"",link:"https://www.4any1assessoria.com.br/",source:""},{name:"Sfugies",description:"A web application using reactjs for the client side, Node.js + Express for the backend server and NoSQL database MongoDB.",link:"https://sfugies.onrender.com/",source:"https://github.com/fekenzofugi/Sfugies"},{name:"Mil Vezes Mãe",description:"",link:"http://mochilacriativa.com.br",source:"https://github.com/fekenzofugi/MilVezesMae"},{name:"Classe do Vinho",description:"",link:"https://classedovinho.com.br",source:""},{name:"Negocia Tudo",description:"",link:"https://negociatudo.com.br",source:""},{name:"Market Mood",description:"",link:"https://marketmood.com.br"}],D1=()=>{const{ref:e,inView:t}=qe();qe();const{ref:n,inView:r}=qe();return g.jsxs(O1,{children:[g.jsx("header",{ref:n,className:`${r?"grow":"hide"}`,children:g.jsx("h1",{ref:e,className:`${t?"animate":"hide"}`,children:"Web Apps"})}),g.jsx("div",{className:"works",children:M1.map(o=>{const{name:i,description:l,link:a,source:s}=o;return g.jsx(A1,{className:"work",name:i,description:l,link:a,source:s},i)})})]})},O1=xe.div`
...
`,Y1=()=>g.jsxs(G1,{children:[g.jsx("h4",{children:"Technologies"}),g.jsx("br",{}),g.jsx("hr",{}),g.jsx("h5",{children:"Programming Languages"}),g.jsxs("ol",{children:[g.jsx("li",{children:"Python"}),g.jsx("li",{children:"JavaScript"}),g.jsx("li",{children:"Typescript"})]}),g.jsx("br",{})]}),G1=xe.div`
    h4{
        margin-top: 1rem;
        font-weight: 500;
    }
